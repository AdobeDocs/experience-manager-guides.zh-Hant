---
title: 發行說明 | 2023年9月發行的Adobe Experience Manager Guides新增功能
description: 在2023年9月發行的Adobe Experience Manager Guides as a Cloud Service中瞭解新功能和增強功能
...
本文介紹2023年9月版Adobe Experience Manager Guides （以後稱為&#x200B;*AEM Guides as a Cloud Service*）中的新功能和增強功能。
...
除了現有的現成可用聯結器（如JIRA和SQL） (MySQL、PostgreSQL、SQL Server、SQLite)，您的管理員還可以為MariaDB、H2DB、AdobeCommerce和Elasticsearch資料庫設定聯結器。 它們也可以藉由擴充預設介面來新增其他聯結器。
...
下列原生PDF增強功能已在2023年9月版本中完成，以讓AEM Guides成為更強大的產品：
...
![編輯地圖集合](assets/edit-map-collection-cs.png){width="800"}\
*選取對應集合中的所有預設集。*
...
![預覽窗格](assets/quick-preview_cs.png){width="800"}
