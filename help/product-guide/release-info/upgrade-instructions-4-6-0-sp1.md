...
如需此版本中已修正的問題清單，請檢視4.6.0 Service Pack 1版本[中的](fixed-issues-4-6-0-sp1.md)已修正問題。
...
4.6.0 Service Pack 1版本的升級程式遵循與4.6.0版本相同的步驟。 如需詳細指示，請檢視Experience Manager Guides內部部署版本[的](../install-guide/upgrade-xml-documentation.md)升級指示。
