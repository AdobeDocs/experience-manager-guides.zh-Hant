---
title: 發行說明 | Adobe Experience Manager Guides 5.1.0 Service Pack 4版本的升級指示
description: 瞭解相容性矩陣，以及如何升級至Adobe Experience Manager Guides的5.1.0 Service Pack 4版本。
...
ht-degree: 4%
---
# 5.1.0 Service Pack 4版本（2026年4月）的升級指示

本文介紹Adobe Experience Manager Guides 5.1.0 Service Pack 4版的升級指示和相容性矩陣。

如需此版本中已修正的問題清單，請檢視5.1.0 Service Pack 4版本](../release-info/fixed-issues-5-1-0-sp4.md)中的[已修正問題。

## 相容性矩陣

本節列出Experience Manager Guides 5.1.0 Service Pack 4版本支援之軟體應用程式的相容性矩陣。
...
| 發行版本 | FMPS | FM |
| --- | --- | --- |
| 5.1.0 Service Pack 4 (UUID) | 支援 | 2022或更高 |
...
## 升級至Experience Manager Guides的5.1.0 Service Pack 4版本

您可以輕鬆地將您目前的Experience Manager Guides版本升級為&#x200B;**AEM 6.5**&#x200B;或&#x200B;**AEM 6.5 LTS**&#x200B;上的5.1.0 Service Pack 4版本。
...
在繼續升級至Experience Manager Guides 5.1.0 Service Pack 4版之前，您必須考量下列幾點：

- 如果您是使用5.1.0或5.1.x版，則可以直接升級至5.1.0 Service Pack 4版。
