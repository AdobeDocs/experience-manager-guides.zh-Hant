...
如需此版本中已修正的問題清單，請檢視5.1.0 Service Pack 1版本](../release-info/fixed-issues-5-1-0-sp1.md)中的[已修正問題。

## 相容性矩陣

本節列出Experience Manager Guides 5.1.0 Service Pack 1版本支援之軟體應用程式的相容性矩陣。
