---
title: 發行說明 | Adobe Experience Manager Guides 2023年11月版本中的升級指示和修正問題
...
2. 將Cloud Services Git程式碼的`/dox/dox.installer/pom.xml`檔案中的`<dox.version>`屬性更新為2023.11.0.406。
