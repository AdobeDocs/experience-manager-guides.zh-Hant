---
title: 發行說明 | Adobe Experience Manager Guides 2026.04.0版的新增功能
description: 瞭解2026.04.0版Adobe Experience Manager Guides中的新功能和增強功能
role: Leader
...
# 2026.04.0版的新增功能（2026年4月）

本文介紹2026.04.0版Adobe Experience Manager Guides as a Cloud Service所推出的新功能和增強功能。

如需此版本中修正的問題清單，請檢視[2026.04.0版本](fixed-issues-2026-04-0.md)中的已修正問題。

瞭解2026.04.0版](../release-info/upgrade-instructions-2026-04-0.md)的[升級指示。
