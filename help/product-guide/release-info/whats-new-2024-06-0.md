...
description: 瞭解Adobe Experience Manager Guides as a Cloud Service 2024.06.0版中的新功能和增強功能。
...
![檔案屬性選項標籤](./assets/file-properties-outputs-tab.png){width="300"}
...
![環繞元素對話方塊](./assets/surround-element.png) {width="300"}
...
Experience Manager Guides也支援原生PDF發佈中的Markdown檔案。 此功能相當實用，可協助您為DITA map中的Markdown檔案產生PDF。 原生PDF發佈中的Markdown支援可協助您輕鬆建立、管理和共用檔案。
