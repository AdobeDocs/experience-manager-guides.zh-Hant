...
|---|---|---|---|---|---|---|
| Adobe Experience Manager Guides 2026.08.0 <br> | 自動更新 | ~ 2026年7月 | - | - | - | 目標 |
...
| 發行 | 事件 | 排程 | 新增功能 | 升級指示 | 已修正的問題 | 狀態 |
|---|---|---|---|---|---|---|
| Adobe Experience Manager Guides 2026.06.0 <br> [（AEM版本 — 26635）](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/release-notes/maintenance/latest) | 自動更新 | 2026年6月22至24日 | [這裡](whats-new-2026-06-0.md) | [這裡](upgrade-instructions-2026-06-0.md) | [這裡](fixed-issues-2026-06-0.md) | 已更新 |
