---
title: 發行說明 | Adobe Experience Manager Guides 5.0.0 Service Pack 3版本的升級指示
description: 瞭解相容性矩陣，以及如何升級至Adobe Experience Manager Guides的5.0.0 Service Pack 3版本。
...
# 5.0.0 Service Pack 3版本（2026年2月）的升級指示

本文介紹Adobe Experience Manager Guides 5.0.0 Service Pack 3版的升級指示和相容性矩陣。

如需此版本中已修正的問題清單，請檢視5.0.0 Service Pack 3版本[中的](../release-info/fixed-issues-5-0-0-sp3.md)已修正問題。

## 相容性矩陣

本節列出Experience Manager Guides 5.0.0 Service Pack 3版本支援之軟體應用程式的相容性矩陣。
...
| 發行版本 | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 3 (UUID) | 支援 | 2022或更高 |
...
## 升級至Experience Manager Guides的5.0.0 Service Pack 3版本

您可以輕鬆地將目前版本的Guides升級至5.0.0 Service Pack 3版。 在繼續升級至Experience Manager Guides 5.0.0 Service Pack 3版之前，您必須考量下列幾點：

- 如果您是使用5.0.0 Service Pack 2、5.0.0 Service Pack 1或5.0.0版，則可以直接升級至5.0.0 Service Pack 3版。
