---
title: 發行說明 |修正2024.10.0版Adobe Experience Manager Guides中的問題
...
本文介紹2024.10.0版Adobe Experience Manager Guides as a Cloud Service中不同區域修正的錯誤。
...
- Experience Manager Guides as a Cloud Service中的PDF轉譯功能會發生間歇性失敗。 (16966)
...
- 插入包含「&lt;」符號的MathML方程式時，會產生&#x200B;**無效的字元**&#x200B;錯誤。 (18742)
...
- **大量發佈儀表板**&#x200B;對於仍在翻譯過程中的地圖顯示為空白。 (19352)
...
- 在啟用微服務的環境中，發佈附有條件的AEM網站的單一主題會失敗。
