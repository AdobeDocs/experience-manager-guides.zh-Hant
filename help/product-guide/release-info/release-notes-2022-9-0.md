...
1. 將Cloud Services Git程式碼的`/dox/dox.installer/pom.xml`檔案中的`<dox.version>`屬性更新為2022.9.178。
...
* 新增地圖編輯器 |如果我們從&#x200B;**作者**&#x200B;切換到&#x200B;**配置**&#x200B;檢視，在地圖示題中新增的粗體或斜體文字將不會保留。 (10218)
...
* 原生PDF | `xref`概念未正確解析特定DITA主題。 (10229)
* 原生PDF |無法在產生的PDF輸出中檢視表格的標題文字。 (9827)
* 原生PDF |附錄中的參照不會在PDF輸出中顯示為附錄。 (10182)
* 原生PDF |資料表的Frame屬性不會傳播至temp HTML (as class)。 (10353)
* 原生PDF | temp HTML檔案會將colsep和rowsep類別新增至td和th，即使它們在來源DITA中的值為0亦然。 (10352)
* 原生PDF |不會接受在頁面配置中新增之條件的中繼資料。 (10377)
* 原生PDF |產生特定內容的PDF失敗。 (9927)
