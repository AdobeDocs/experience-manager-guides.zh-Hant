...
# 2023年2月版Adobe Experience Manager Guides as a Cloud Service的新增功能

本文介紹2023年2月版Adobe Experience Manager Guides （以後稱為&#x200B;*AEM Guides as a Cloud Service*）中的新功能和增強功能。
...
現在AEM指南提供改良的UX，可幫助您檢閱共用供檢閱的主題。 在最新體驗中，稽核功能有下列增強功能：
...
如需詳細資訊，請參閱[為AEM Guides as a Cloud Service設定新的微服務式發佈](https://experienceleague.adobe.com/docs/experience-manager-guides-learn/tutorials/knowledge-base/publishing/configure-microservices.md)。

## 原生PDF |在PDF輸出中新增自訂書籤

現在，您可以在最終PDF輸出中的特定內容新增自訂書籤，以方便瀏覽。 這將會新增至目錄，此目錄是根據DITA map中的主題或區段標題建立的。

## 原生PDF |在目錄專案和主題內容套用自訂樣式

AEM Guides提供在目錄專案或PDF輸出中的特定主題套用自訂樣式的功能。 例如，您可以變更目錄中的文字顏色和主題標題。 您也可以在主題內的整個內容上套用樣式。
...
AEM Guides現在可讓您快速識別PDF輸出之目錄中的已變更主題。  它會在目錄中已變更的主題左側顯示變更列。 您可以按一下目錄中的主題並檢視詳細變更。
