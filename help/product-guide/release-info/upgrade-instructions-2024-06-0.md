...
description: 瞭解相容性矩陣，以及如何升級至2024.06.0版Adobe Experience Manager Guidesas a Cloud Service。
...
本文介紹2024.06.0版Adobe Experience Manager Guidesas a Cloud Service的升級指示和相容性矩陣。
...
本節列出2024.06.0版Experience Manager指南as a Cloud Service支援之軟體應用程式的相容性矩陣。

### FrameMaker和FrameMaker Publishing Server

| 雲端版Experience Manager指南 | FMPS | FrameMaker |
| --- | --- | --- |
| 2024.06.0 | 不相容 | 2022或更高 |
| | | |
...
| 元件封裝名稱 | 元件版本 | 範本版本 |
|---|---|---|
| 適用於Cloud Service的Experience Manager指南元件內容套件 | dxml-components.all-1.2.2 | aem-site-template-dxml.all-1.0.16 |
...
在上一個回應JSON中，金鑰 `lockNodePath` 會儲存存放庫中建立之節點的路徑，指向已提交的工作。 工作完成後，系統會自動將其刪除。 您可以參照此節點來瞭解作業的狀態。
