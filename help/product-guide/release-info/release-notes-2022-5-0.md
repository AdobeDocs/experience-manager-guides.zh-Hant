---
title: 發行說明 | Adobe Experience Manager Guides as a Cloud Service，2022年5月發行版本
...
1. 將Cloud Services Git程式碼的`/dox/dox.installer/pom.xml`檔案中的`<dox.version>`屬性更新為2022.5.144。
