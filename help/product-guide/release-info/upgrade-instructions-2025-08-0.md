---
title: 發行說明 | 2025.08.0版Adobe Experience Manager Guides中的升級指示和修正問題
description: 瞭解相容性矩陣，以及如何升級至2025.08.0版的Adobe Experience Manager Guides as a Cloud Service。
...
本文介紹2025.08.0版Adobe Experience Manager Guides as a Cloud Service的升級指示和相容性矩陣。
...
本節說明2025.08.0版Experience Manager Guides as a Cloud Service所支援軟體應用程式的相容性矩陣。

### FrameMaker和FrameMaker Publishing Server

| Experience Manager Guides雲端版 | FMPS | FrameMaker |
| --- | --- | --- |
| 2025.08.0 | 不相容 | 2022或更高 |
