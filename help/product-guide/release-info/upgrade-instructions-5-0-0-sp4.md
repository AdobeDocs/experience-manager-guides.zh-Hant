...
如需此版本中已修正的問題清單，請檢視5.0.0 Service Pack 4版本](../release-info/fixed-issues-5-0-0-sp4.md)中的[已修正問題。

## 相容性矩陣

本節列出Experience Manager Guides 5.0.0 Service Pack 4版本支援之軟體應用程式的相容性矩陣。

### Adobe Experience Manager

**5.0.0 Service Pack 4 UUID**
...
| 發行版本 | FMPS | FM |
| --- | --- | --- |
| 5.0.0 Service Pack 4 (UUID) | 支援 | 2022或更高 |

### 氧氣聯結器

| 發行版本 | 氧氣聯結器視窗 | 氧氣聯結器Mac | 在氧氣視窗中編輯 | 在氧氣Mac中編輯 |
| --- | --- | --- |--- |--- |
| 5.0.0 Service Pack 4 (UUID) | 3.7-uuid.2 | 3.7-uuid.2 | 2.3 | 2.3 |
...
## 升級至Experience Manager Guides的5.0.0 Service Pack 4版本

您可以輕鬆地將目前版本的Guides升級至5.0.0 Service Pack 4版。 在繼續升級至Experience Manager Guides 5.0.0 Service Pack 4版之前，您必須考量下列幾點：

- 如果您是使用5.0.0或5.0.x版，則可以直接升級至5.0.0 Service Pack 4版。
