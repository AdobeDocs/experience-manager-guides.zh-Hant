...
如需此版本中已修正的問題清單，請檢視5.1.0 Service Pack 3版本](fixed-issues-5-1-0-sp3.md)中的[已修正問題。

瞭解5.1.0 Service Pack 3版本](../release-info/upgrade-instructions-5-1-0-sp3.md)的[升級指示。
