...
description: 瞭解相容性矩陣，以及如何升級至2024.10.0版的Adobe Experience Manager Guidesas a Cloud Service。
...
本節列出2024.10.0版Experience Manager Guides as a Cloud Service支援之軟體應用程式的相容性矩陣。
