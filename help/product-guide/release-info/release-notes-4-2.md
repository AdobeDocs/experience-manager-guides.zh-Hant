...
* 新增至DITA主題的SVG檔案不會在編輯器的預覽模式下顯示。 (10010)
...
* 原生PDF | 需要在PDF輸出中參照之地圖的中繼資料出現問題。( 10556)
...
* 原生PDF | 原生PDF使用內嵌樣式，而非產生的標籤的類別名稱。 (10498)
...
Adobe已識別AEM Guides 4.2版的下列已知問題：
