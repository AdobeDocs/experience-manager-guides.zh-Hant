---
title: 設定AEM Guides as a Cloud Service的全新微服務式發佈
...
Adobe Experience Manager Guides as a Cloud Service適用的微服務型發佈支援PDF （原生和DITA-OT型）、HTML5、JSON和CUSTOM型別的輸出預設集。
...
1. 如果啟用使用微服務的OSGi設定，發佈程式是否可以在使用相同程式碼基底的本機AEM伺服器上運作？
