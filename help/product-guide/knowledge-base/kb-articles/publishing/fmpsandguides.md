...
- 與4.1 AEM Guides的相容性： [4.1相容性矩陣](/help/product-guide/release-info/release-notes-4.1.md#compatibility-matrix)
...
- 最新版本： [最新版本資訊](/help/product-guide/release-info/latest-release-info.md)
