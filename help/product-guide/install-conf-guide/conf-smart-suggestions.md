...
7. [在資料夾設定檔中設定智慧建議](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)
...
如需詳細資訊，請參閱[在資料夾設定檔](./conf-profiles.md#configure-ai-assistant-for-smart-help-and-authoring)中設定智慧建議。
