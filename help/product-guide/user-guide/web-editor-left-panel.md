...
>[!NOTE]
>
> 從2025.11.0版開始，編輯器中的&#x200B;**存放庫**&#x200B;將被棄用，並由&#x200B;**雲端服務**&#x200B;安裝程式的&#x200B;**總管**&#x200B;取代。 針對&#x200B;**內部部署**&#x200B;設定，您將繼續透過編輯器介面檢視及使用存放庫，直到Experience Manager Guides第5.1發行版本為止。
...
>[!NOTE]
>
> 從2025.11.0版開始，對於雲端服務設定，編輯器中的存放庫一詞將由&#x200B;**Explorer**&#x200B;取代。 內部部署設定會繼續在編輯器中看見並存取存放庫。
...
1. 選取「全部取代」**&#x200B;**，以指定的取代字串取代所有搜尋檔案中搜尋字串的所有專案。 取代所有專案後，您將會看到通知。
   ...
   >[!NOTE]
   >
   >若要啟用「**全部取代**」按鈕，您的資料夾設定檔管理員或系統管理員必須在&#x200B;**Workspace設定** （針對&#x200B;**內部部署**&#x200B;顯示為&#x200B;**設定**）的&#x200B;**一般**&#x200B;索引標籤下，選取「**啟用全部取代**」選項。
...
1. 選取&#x200B;**全部取代**，以單一步驟中的取代字詞取代單一檔案中搜尋字詞的所有出現位置。 取代所選檔案中的所有相符項後，您將會看到通知。
   ...
   >[!NOTE]
   >
   > 若要啟用「然後&#x200B;**全部取代**」圖示，您的資料夾設定檔管理員或系統管理員必須在&#x200B;**Workspace設定** （針對&#x200B;**內部部署**&#x200B;顯示為&#x200B;**設定**）的&#x200B;**一般**&#x200B;索引標籤下，選取選項&#x200B;**啟用全部取代**。 如果在取代操作期間發生錯誤，則會因為XML剖析問題或DITA相關錯誤而略過這些檔案。
