...
1. 在&#x200B;**主題**&#x200B;索引標籤中，選取您要發佈的主題。
   ...
   - 使用基準線
     ...
     ![aem sites主題清單，基準線](images/aem-presets-topic-list-new.png)

   >[!NOTE]
   >
   > 在&#x200B;**內容**&#x200B;標籤中選取基準線時，主題清單會顯示附加基準線中的主題及其版本。<br><br>
...
1. 選取要用來再生所選主題的輸出預設集。
   ...
   對於使用舊版元件對映的AEM Sites輸出預設集，如果選取了基準線，則會使用所選基準線中包含的主題版本來產生輸出。 此外，只有當對映結構沒有變更時，才應使用主題清單中的增量發佈。 如果地圖結構/目錄變更，則整個地圖應發佈一次以更新目錄。 如需使用AEM網站預設集的詳細資訊，請在地圖儀表板](./generate-output-aem-site-map-dashboard.md)上檢視[AEM Sites預設集。
