...
使用FrameMaker中的AEM聯結器，您可以管理您的FrameMaker檔案。 AEM聯結器可讓您在AEM上輕鬆上傳DITA和其他FrameMaker檔案(.book和.fm)。 Experience Manager Guides也可讓您直接從AEM發佈FrameMaker檔案。 如果您的FrameMaker書籍檔案包含DITA和.fm檔案的組合，Experience Manager Guides也可以發佈這類檔案。 目前，您可以將PDFook和.fm檔案發佈為PDF、HTML5和EPUB格式。
