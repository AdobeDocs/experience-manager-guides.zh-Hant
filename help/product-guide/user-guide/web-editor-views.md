...
Adobe Experience Manager中的編輯器介面支援以四種不同的模式或檢視檢視檢視主題：
...
如需詳細資訊，請檢視[索引標籤列](web-editor-tab-bar.md)區段中的&#x200B;**尋找和取代**&#x200B;功能說明。
...
並排檢視可讓您在同一熒幕上同時檢視及使用「作者」和「Source」檢視。 WYSIWYG「作者」檢視與底層XML Source檢視會彼此相鄰顯示，啟用平行內容與結構編輯，而不需切換檢視。 兩個檢視會即時保持同步，確保「製作」檢視中的游標位置和選取範圍會反映在Source檢視中的對應位置，在製作結構化內容時可提供較佳的精確度和控制能力。
