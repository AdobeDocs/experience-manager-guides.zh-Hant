...
- *在相同位置拖放*：您有&#x200B;**覆寫現有檔案\(s\)**、**保留兩個檔案\(s\)**&#x200B;的選項。
...
*在不同位置拖放檔案*：您有&#x200B;**覆寫現有檔案\(s\)**、**將檔案移動到新位置\(s\)的選項**。
...
1. 會根據您的設定顯示「大量移動工具」頁面。 在&#x200B;**大量移動工具**&#x200B;頁面上提供下列詳細資料：
   ...
   >[!TIP]
   >
   > 選取 <img src="images/info-icon.svg" width="25">接近任何欄位以檢視更多相關詳細資訊。
