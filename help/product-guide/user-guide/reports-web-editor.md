...
1. 若要更新中繼資料，請選取要更新的檔案。 您可以勾選顯示在&#x200B;**Title**&#x200B;旁的核取方塊，以選取出現在「中繼資料」面板中的檔案。
   ...
   >[!NOTE]
   >
   > 如果檔案已由其他使用者鎖定，則無法選取它來更新中繼資料。 鎖定圖示也會出現在已鎖定檔案的標題附近。 您可以將滑鼠停留在圖示上以檢視使用者名稱。 您可以設定&#x200B;**管理**&#x200B;按鈕，在選取的檔案處於唯讀模式時將其停用。 如需詳細資訊，請檢視中繼資料面板[&#128279;](../guides-ui-extensions/examples.md)上的管理按鈕。
   >
