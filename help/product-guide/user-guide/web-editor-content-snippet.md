...
- 如果您使用的是2023年10月發行版本或更新版本，請在Cloud Services安裝與設定指南中瞭解如何[從使用者介面](../cs-install-guide/conf-data-source-connector-tools.md)設定資料來源聯結器。

- 如果您使用的是2023年7月或2023年9月版本，請瞭解如何在雲端服務安裝與設定指南中[設定資料來源聯結器](../cs-install-guide/conf-data-source-connector.md)。
