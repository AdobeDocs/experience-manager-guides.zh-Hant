...
1. 登入您的AEM執行個體&#x200B;*\（以管理員身分\）*，並導覽至CRX封裝管理員。 存取封裝管理器的預設URL為
   ...
   套件管理器會管理本機AEM安裝上的套件。 如需使用封裝管理員的詳細資訊，請參閱AEM檔案中的[如何使用封裝](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developer-tools/package-manager.html?lang=en)。
