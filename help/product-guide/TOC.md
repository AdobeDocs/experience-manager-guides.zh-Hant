   ...
   - 管理學習內容 {#learning-training-content}
      - 快速入門手冊 {#get-started}
         - 簡介 {#intro-lc}
            ...
            - [發行說明](./release-info-lt/release-notes-lt-2026-02-v3.md)
...
- 安裝和設定 {#install-guide}
   - 內部部署 {#on-prem-ig}
      ...
      - 使用輸出產生設定 {#output-gen-config}
         ...
         - [下載並安裝AEM Sites範本](./install-guide/download-install-aem-sites-templates.md)
         - [AEM Sites的元件對應](./install-guide/component-mapping.md)
   ...
   - 雲端服務 {#cs-ig}
      ...
      - 使用輸出產生設定 {#output-gen-config-cs}
         ...
         - [AEM Sites的元件對應](./cs-install-guide/component-mapping.md)
...
- 安裝和設定 {#install-conf-guide}
   ...
   - 內部部署的安裝程式 {#deploy-conf-aemg-on-prem}
      ...
      - [解除安裝AEM Guides](./install-conf-guide/unistall-aemg.md)
   ...
   - 內容移轉 {#migrate-content-cs}
      ...
      - [使用Framemaker和WebDav工具上傳現有DITA內容（內部部署）](./install-conf-guide/upload-dita-content.md)
