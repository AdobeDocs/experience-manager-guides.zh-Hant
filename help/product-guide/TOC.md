...
- {hide-from-toc}[AEM Guides登陸頁面](aemg-documentation-overview.md)
...
- 安裝和設定 {#install-conf-guide}
  ...
  - 編輯器設定 {#editor-configs}
    ...
    - 適用於Cloud Service的編輯器設定 {#editor-cloud-settings}
      ...
      - [在用於Cloud Service的編輯器中設定翻譯功能](./install-conf-guide/conf-translation-editor.md)
      - [建立和管理健康狀態檢查預設集](./install-conf-guide/conf-health-check-preset.md)
  ...
  - 擴充功能 {#aemg-customization}
    ...
    - [為稽核任務中的主題編制索引](./install-conf-guide/index-review-tasks.md)
