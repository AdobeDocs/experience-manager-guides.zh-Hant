...
您可以將目前的Experience Manager Guides版本升級為5.0.0 Service Pack 1版：


- 如果您是使用5.0.0、4.6.x、4.6或4.4版，則可以直接升級至5.0.0 Service Pack 1版。
...
>[!TIP]
>
> 升級至5.0.0 Service Pack 1版須視目前Experience Manager Guides的版本而定。 如果您是使用5.0.0、4.6.4、4.6.3、4.6.1、4.6.0或4.4版，則可以直接升級至5.0.0 Service Pack 1版。
