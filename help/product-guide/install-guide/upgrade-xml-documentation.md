...
您可以將目前的Experience Manager Guides版本升級至5.1.0 Service Pack 4版：

- 如果您是使用5.1.0版或5.1.x版，則可以直接升級至5.1.0 Service Pack 4版。
...
>[!NOTE]
>
>如果您升級至5.1.0 Service Pack 4，則需使用5.1.0或5.1.x版的Experience Manager Guides。
