...
您可以將目前的Experience Manager Guides版本升級至4.4.0版：
...
1. 選取&#x200B;**DAM更新資產工作流程**。
1. 按一下&#x200B;**編輯**。
1. 如果&#x200B;**DXML Post Process Initiator**&#x200B;元件存在，請確定自訂已同步。
1. 如果&#x200B;**DXML Post Process Initiator**&#x200B;元件不存在，請執行下列步驟以插入它：
