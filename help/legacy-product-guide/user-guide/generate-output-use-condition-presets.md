...
建立條件預設集後，會顯示在輸出預設集的&#x200B;**條件預設集**&#x200B;下拉式清單中。 深入瞭解如何[發佈PDF輸出](/help/product-guide/web-editor/native-pdf-web-editor.md)。
...
1. Select **Duplicate** from the Options menu to open the **Duplicate condition preset** dialog.
   >[!NOTE]
   >
   > The default name of the preset is `<selected condition preset name>_1`. 您可以根據自己的需求變更名稱。
