...
An email is sent to all the reviewers, notifying that they have been assigned topics for review. 電子郵件包含直接連結，使用者可按一下該連結並在瀏覽器視窗中存取主題。 The topics along with the DITA map are opened in the review mode.
