...
例如，您可以在Experience Manager Guides中建立檔案主題。 您可以詢問，*如何建立主題？* 您會收到回應，以及相關文章的連結。 之後，如果您想瞭解如何產生檔案的PDF輸出，可以詢問相關問題。 例如，*如何將主題發佈至PDF？* 或&#x200B;*如何產生主題的PDF輸出？*
...
![智慧型說明面板](images/smart-help-panel.png){width="300"}
...
1. 選取&#x200B;**傳送** ![傳送圖示](images/send-icon.svg)或按&#x200B;**Enter**&#x200B;檢視您問題的回應。
   ...
   ![智慧型說明面板回應](images/smart-help-panel-response.png){width="300"}
